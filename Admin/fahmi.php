...
<html lang="en">
  ...
  <body>
    <ul class="nav justify-content-center bg-light fixed-top">
      ...
      <li class="nav-item">
        <a class="nav-link initial" href="#" aria-current="page">Fahmi</a>
      </li>
    ...
    <div class="all-body-cover">
      ...
      <img
      src="assets/img/fahmi.jpg"
      class="profile-picture"
      alt="Foto Profil Fahmi"
    />
  </div>
      <div class="nama">
        <h4 class="text-center fw-bold">Fahmi Arifin</h4>
          ...
          <div class="container text-center">
            <div class="row">
              <div
                ...
                class="col-sm-4 mb-2"
                >
                Halo, perkenalkan nama saya Fahmi Arifin, yang sering dipanggil Fahmi. Saya adalah seorang tunadaksa ringan. Saat ini, saya sedang menempuh pendidikan di jurusan Sistem Informasi di Institut Teknologi dan Bisnis Indonesia. Selama masa sekolah dan kuliah, saya telah meraih beberapa pencapaian dan penghargaan. Saat ini, saya sedang belajar beberapa keterampilan, salah satunya adalah keterampilan pemrograman.
              </div>
              <div
                data-aos="fade-up"
                data-aos-duration="800"
              ...
              >
                ...
                <div class="education">
                  ...
                  <p class="startEnd">Started on apr 2007</p>
                  <button
                    type="button"
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          1. Juara III Olimpiade Matematika SD Tingkat propinsi 2007<br />
                          2. Juara III Olimpiade Matematika SD Tingkat propinsi 2009 <br />
                          3. Juara I Olimpiade Matematika SD Tingkat propinsi 2010 <br />
                          4. Juara I Olimpiade MIPA SD Tingkat propinsi 2011 <br />
                          5. Harapan 1 Olimpiade MIPA SD Tingkat Nasional 2011 <br />
                          6. Juara I Olimpiade Matematika SD Tingkat propinsi 2012 <br />
                          7. Juara II Olimpiade Matematika SD Tingkat Nasional 2012 <br />
                          8. Juara I Olimpiade Matematika SD Tingkat propinsi 2013 <br />
                          9. Harapan 1 Olimpiade Matematika SD Tingkat Nasional 2013<br />
                  ...
                  <p class="startEnd">Finished on Jun 2013</p>
                  <i class="fas fa-arrow-circle-down itemEdu"></i>
                  <!-- <i class="fas fa-arrow-circle-down itemEdu"></i> -->
                  <p class="startEnd">Started on Jul 2013</p>
                  <button
                    type="button"
                    class="btn btn-danger itemEdu"
                    data-bs-toggle="modal"
                  ...
                  >
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                         1. Juara 1 Olimpiade Matematika SMP Tingkat Propinsi 2014 <br />
                         2. Juara III  Olimpiade Matematika SMP Tingkat Propinsi 2014 <br />
                         3. Juara II Olimpiade IPA SMP Tingkat Propinsi 2015 <br />
                         4. Juara II Menulis Sipnosis SMP Tingkat Propinsi 2016 <br />
                  ...
                  <p class="startEnd">Finished on Jun 2016</p>
                  <i class="fas fa-arrow-circle-down itemEdu"></i>
                  <!-- <i class="fas fa-arrow-circle-down itemEdu"></i> -->
                  ...
                  >
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          1. Harapan III Menulis Cerpen SMA Tingkat Propinsi 2017 <br />
                          2. Juara I Desain Poster Tingkat Ragional Sumatra 2017 <br />
                          3. Juara I Kelompok Desain Cover Majalah  Tingkat Ragional Sumatra 2017 <br />
                          4. Juara III Photoshop Tingkat Ragional Sumatra 2017 <br />
                  ...
                  <p class="startEnd">Finished on Jun 2019</p>
                  <i class="fas fa-arrow-circle-down itemEdu"></i>
                  <!-- <i class="fas fa-arrow-circle-down itemEdu"></i> -->
                  <p class="startEnd">Started on 2021</p>
                  <button
                    type="button"
                    class="btn btn-danger itemEdu"
                    data-bs-toggle="modal"
              ...
              Saya memiliki hobi untuk mempelajari hal-hal baru, terutama yang berkaitan dengan perkembangan teknologi. Seringkali, saya menyalurkan pemikiran dan pengetahuan baru tersebut dalam bentuk tulisan, seperti puisi dan kutipan, yang kemudian saya unggah di situs web saya. Selain itu, saya juga gemar menciptakan konten yang saya bagikan di media sosial saya. Salah satu kegiatan yang saya nikmati adalah berdiskusi tentang teknologi bersama teman-teman saya.
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-3">
            ...
            >
              ...
              <div class="card-body">
                <h5 class="card-title">Gelegar Bangsa Radio</h5>
                <p class="card-text">
                Saya pernah menjadi manajer periklanan yang bertanggung jawab dalam pembuatan iklan dan konten radio, baik dalam bentuk teks maupun audio.
                </p>
              </div>
            </div>
          </div>
          <div class="col-sm-3">
            ...
            >
              <div class="card-header"></div>
              <div class="card-body">
                <h5 class="card-title">Peraih Beasiswa</h5>
                <p class="card-text">
                menjadi salah satu dari 20 peserta yang berhasil meraih beasiswa dari PLN Indonesia dan Yayasan Menembus Batas, di tengah persaingan ketat dengan 40 peserta dari berbagai kampus di Indonesia.
                </p>
              </div>
            </div>
          </div>
          <div class="col-sm-3">
            ...
            >
              <div class="card-header"></div>
              <div class="card-body">
                <h5 class="card-title">Magang Adminitrasi</h5>
                <p class="card-text">
                  Penah Magang Menjadi Adminitrasi di Sebuah lembaga pelatihan
                </p>
              </div>
            </div>
          </div>
          <div class="col-sm-3">
            ...
            >
              <div class="card-header"></div>
              <div class="card-body">
                <h5 class="card-title">Pelatihan Komputer </h5>
                <p class="card-text">
                 Menjadi Salah Satu Penerima Mafaat Di PSBD Palembang
                  Dengan Mendapatkan Pelatihan Komputer
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="row justify-content-md-center">
        <div data-aos="fade-up" data-aos-duration="800" class="col">
          <div class="article-container-firstRow text-uppercase mx-auto">
            <a
              href="https://link-ke-halaman-komunitas-anda"
              style="text-decoration: none"
            >
              <div class="article-img-holder-firstRow">Web Komunitas</div>
            </a>
          </div>
        </div>
      </div>
